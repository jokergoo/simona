...
output: 
  html_vignette:
    ...
    toc: true
vignette: >
  %\VignetteIndexEntry{1. ontology_DAG: a class for ontology data}
...
`dag_permutate_children()` randomly permute child terms under every term.

```{r, eval = FALSE}
dag4 = dag_permutate_children(dag)
```
