...
$$ \mathrm{Sim}(a, b) = 1 - \frac{\tanh \left( \sum\limits_{x \in L_c(a, b)} \frac{1}{\mathrm{IC}(x)} \right)}{\pi/2} $$
...
$$ \mathrm{Sim}(a, b) = 1 - \frac{\tanh \left( \sum\limits_{x \in L_c(a, b)} T(x) \right) }{\pi/2} $$
