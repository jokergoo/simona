...
offspring terms of the term. Dot size corresponds to the number of child
terms. If colors are not set, let's say root term is on level 0, the DAG is
cut at level-0 terms (links between level-1 terms and level-0 terms are all
cut), and each sub-DAG is assigned with a different color. A legend of top
terms of sub-DAGs is also added in the plot.
